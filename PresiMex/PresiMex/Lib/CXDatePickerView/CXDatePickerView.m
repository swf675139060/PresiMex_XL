...
- (void)setupUI {
    ...
    self.buttomView.layer.cornerRadius = 15.0;
    self.buttomView.layer.maskedCorners = kCALayerMinXMinYCorner | kCALayerMaxXMinYCorner;
...
- (void)initPickerHeaderView {
    self.headerView = [[UIView alloc]initWithFrame:CGRectMake(0, _pickerViewHeight, PickerBackViewWeight, PickerHeaderHeight)];
    _headerView.backgroundColor = [UIColor whiteColor];
    [self.buttomView addSubview:_headerView];
    
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, WF_ScreenWidth - 70 * 2, PickerHeaderHeight)];
    titleLabel.textAlignment = NSTextAlignmentCenter;
    titleLabel.center = self.headerView.center;
    self.headerTitleLabel = titleLabel;
    [_headerView addSubview:titleLabel];
    
    CGRect cancelButtonFrame  = CGRectMake(35, 15, 115, 40);
    CGRect confirmButtonFrame = CGRectMake(PickerBackViewWeight - 115 - 35, 15, 115, 40);
    ...
    cancelButton.layer.borderColor = BColor_Hex(@"#999999", 1).CGColor;
...
//    confirmButton.backgroundColor = BColor_Hex(@"#FFD102", 1);
//    (PickerBackViewWeight - 115 - 35, 15, 115, 40)
    
    [confirmButton addLinearGradientwithSize:CGSizeMake(115, 40) maskedCorners:kCALayerMinXMinYCorner | kCALayerMaxXMinYCorner | kCALayerMinXMaxYCorner | kCALayerMaxXMaxYCorner cornerRadius:20];
...
- (void)show {
    ...
    [UIView animateWithDuration:self.showAnimationTime animations:^{
        ...
        self.buttomView.frame = CGRectMake(0, WF_ScreenHeight - buttomViewHeight, WF_ScreenWidth, buttomViewHeight);
...
- (void)dismiss {
    [UIView animateWithDuration:self.showAnimationTime animations:^{
        CGFloat buttomViewHeight = self.pickerViewHeight + self.topViewHeight;
        self.buttomView.frame = CGRectMake(0, WF_ScreenHeight, WF_ScreenWidth, buttomViewHeight);
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    switch (self.manager.datePickerStyle) {
        ...
        case CXDateYearMonth:
            ...
            if (component == 0) {
                title =  [NSString stringWithFormat:@"%@%@",self.manager.yearArray[row],@"年"];
            }
            if (component == 1) {
                title =  [NSString stringWithFormat:@"%@%@",self.manager.monthArray[row],@"月"];
            }
            break;
