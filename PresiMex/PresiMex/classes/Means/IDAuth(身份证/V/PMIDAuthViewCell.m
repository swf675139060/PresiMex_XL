...
-(void)setCellWithModel:(PMIDAuthModel*)model{
    ...
    if (model.type==0) {
        if (model.heldImage) {
            [self.imgView setImage:model.heldImage];
            _desTitleLabel.hidden=YES;
        }else if (model.held.length!=0) {
            ...
            [self.imgView setImage:[UIImage imageNamed:@"ID_Auth_Default_1"]];
            _desTitleLabel.hidden=NO;
        }
        
    }else if (model.type==1){
        if (model.silentImage) {
            [self.imgView setImage:model.silentImage];
            _desTitleLabel.hidden=YES;
        }else if (model.silent.length!=0) {
            ...
            [self.imgView setImage:[UIImage imageNamed:@"ID_Auth_Default_2"]];
            _desTitleLabel.hidden=NO;
        }
        
    }else if (model.type==2){
        
        if (model.acousticImage) {
            [self.imgView setImage:model.acousticImage];
            _desTitleLabel.hidden=YES;
        }else if (model.acoustic.length!=0) {
            ...
            [self.imgView setImage:[UIImage imageNamed:@"ID_Auth_Default_3"]];
            _desTitleLabel.hidden=NO;
        }
