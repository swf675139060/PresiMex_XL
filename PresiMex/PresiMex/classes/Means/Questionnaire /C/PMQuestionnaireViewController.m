...
-(void)didTableViewRowWithModel:(PMQuesModel*)model withIndex:(NSInteger)row{
    ...
    weakify(self)
//<<<<<<< HEAD
    JKPickerViewAppearance *alert=[[JKPickerViewAppearance alloc] initWithPickerViewTilte:@"" withData:model.datas pickerCompleteBlock:^(id  _Nonnull responseObjct,NSInteger indx) {
//=======
