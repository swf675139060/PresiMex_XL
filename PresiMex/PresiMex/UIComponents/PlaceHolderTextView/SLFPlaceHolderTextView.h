...
@class SLFPlaceHolderTextView;

typedef void(^SLFTextViewHandler)(SLFPlaceHolderTextView *textView);

IB_DESIGNABLE

@interface SLFPlaceHolderTextView : UITextView
 ...
 */
- (void)addTextDidChangeHandler:(SLFTextViewHandler)eventHandler;
