...
- (BOOL)gestureRecognizerShouldBegin:(UIPanGestureRecognizer *)gestureRecognizer
{
    ...
    CGPoint starPoint = [gestureRecognizer locationInView:self.navigationController.view];
//    NSLog(@"NSStringFromCGPoint:%@",NSStringFromCGPoint(starPoint));
    if (starPoint.x > [UIScreen mainScreen].bounds.size.width/4) {
        return NO;
    }
